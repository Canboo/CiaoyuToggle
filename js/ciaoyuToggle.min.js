 ...
 */
!function(t){"use strict";function n(){t("[data-ciaoyu-toggle]").each(function(){var n,i,a,c;t(this).toggle((n=t(this),i=n.data("ciaoyu-toggle").split(","),a=n.data("ciaoyu-val"),c=!1,t.each(i,function(n,i){var o,r,u;if(0>i.indexOf("+")?c=e(i,a):(o=a,r=i.split("+"),u=!1,t.each(r,function(t,n){if(!(u=e(n,o)))return!1}),c=u),c)return!1}),c))})}function e(n,e){return"select"==t("#"+n).prop("tagName").toLowerCase()?function(t,n){if(0!==n.length){n=n.toString();var e=t.find(":selected").val();if(0>n.indexOf("!")){var i=n.split(",");if(0<=jQuery.inArray(e,i))return!0}else if("!"+e!=n)return!0}return!1}(t("#"+n),e):t("#"+n).is(":checked")}t.fn.ciaoyuToggle=function(e){var i={callback:function(){n()}},a=t.extend(i,e);return this.each(function(){t(this).on("change",a.callback)})},t(function(){n(),t(".ciaoyu-toggle").each(function(){t(this).ciaoyuToggle()})})}(jQuery);
